...
<html>
  ...
  <head>
    ...
    <title>Class DrawerAttribute
   | Funique Documentation </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class DrawerAttribute
        ...
        <div class="body-content">
            ...
            <main class="main-panel">
                ...
                <div role="main" class="hide-when-search">
                    ...
                    <article class="content wrap" id="_content" data-uid="NaughtyAttributes.DrawerAttribute">
  
  
  <h1 id="NaughtyAttributes_DrawerAttribute" data-uid="NaughtyAttributes.DrawerAttribute" class="text-break">Class DrawerAttribute
  </h1>
  <div class="markdown level0 summary"><p sourcefile="api/NaughtyAttributes.DrawerAttribute.yml" sourcestartlinenumber="2">Base class for all drawer attributes</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level2"><span class="xref">UnityEngine.PropertyAttribute</span></div>
    <div class="level3"><span class="xref">DrawerAttribute</span></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.AllowNestingAttribute.html">AllowNestingAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.AnimatorParamAttribute.html">AnimatorParamAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.CurveRangeAttribute.html">CurveRangeAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.DropdownAttribute.html">DropdownAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.EnumFlagsAttribute.html">EnumFlagsAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.ExpandableAttribute.html">ExpandableAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.HorizontalLineAttribute.html">HorizontalLineAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.InfoBoxAttribute.html">InfoBoxAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.InputAxisAttribute.html">InputAxisAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.LayerAttribute.html">LayerAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.MinMaxSliderAttribute.html">MinMaxSliderAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.ProgressBarAttribute.html">ProgressBarAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.ResizableTextAreaAttribute.html">ResizableTextAreaAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.SceneAttribute.html">SceneAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.ShowAssetPreviewAttribute.html">ShowAssetPreviewAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.SortingLayerAttribute.html">SortingLayerAttribute</a></div>
      <div class="level4"><a class="xref" href="NaughtyAttributes.TagAttribute.html">TagAttribute</a></div>
  </div>
  <div classs="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="NaughtyAttributes.INaughtyAttribute.html">INaughtyAttribute</a></div>
  </div>
  <div class="inheritedMembers">
    <h5>Inherited Members</h5>
    <div>
      <span class="xref">UnityEngine.PropertyAttribute.order</span>
    </div>
    <div>
  ...
  <h6><strong>Namespace</strong>: <a class="xref" href="NaughtyAttributes.html">NaughtyAttributes</a></h6>
  <h6><strong>Assembly</strong>: Funique.Core.dll</h6>
  <h5 id="NaughtyAttributes_DrawerAttribute_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class DrawerAttribute : PropertyAttribute, INaughtyAttribute</code></pre>
  </div>
  <h3 id="implements">Implements</h3>
  <div>
      <a class="xref" href="NaughtyAttributes.INaughtyAttribute.html">INaughtyAttribute</a>
  </div>
</article>
